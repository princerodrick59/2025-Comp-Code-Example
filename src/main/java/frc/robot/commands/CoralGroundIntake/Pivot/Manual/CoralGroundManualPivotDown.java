...
public class CoralGroundManualPivotDown extends Command {
  private CoralGroundIntakeSubsystem m_CoralGroundIntakeSubsystem;
  /** Creates a new CoralGroundIntakePivotUp. */
  public CoralGroundManualPivotDown(CoralGroundIntakeSubsystem coralGroundIntakeSubsystem) {
  ...
  @Override
  public void execute() {
    m_CoralGroundIntakeSubsystem.intakePivotDown();
  }
